...
require([
  ...
  var CallSettings = (function(window, document, undefined) {
    ...
    function cs_initCallForwardingClickEvent() {
      ...
      var mapping = {
        mobileBusy: {
          menuItemSelector: '.menuItem-callForwardingMobileBusy',
          panelId: 'call-cf-mobile-busy-settings',
          settingsKey: 'mobilebusy'
        },
        noReply: {
          menuItemSelector: '.menuItem-callForwardingNoReply',
          panelId: 'call-cf-no-reply-settings',
          settingsKey: 'noreply'
        },
        notReachable: {
          menuItemSelector: '.menuItem-callForwardingNotReachable',
          panelId: 'call-cf-not-reachable-settings',
          settingsKey: 'notreachable'
        },
        unconditional: {
          menuItemSelector: '.menuItem-callForwardingUnconditional',
